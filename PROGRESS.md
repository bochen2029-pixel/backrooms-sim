...
| **M20** | The Shoggoth: deterministic maze-navigating chase creature (+ M20b body) | M20 | ✅ `m20b-green` |
| **M21** | The Shoggoth's KEEL brain (LLM intent → navigator; replay bit-exact, model off) | M21 | ✅ `m21-green` |
